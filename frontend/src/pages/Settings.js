      ...
      <Card>
        ...
        <CardContent className="space-y-3">
          ...
          {userRole === 'lawyer' && (
            <>
              ...
              <div>
                ...
                <p className="font-medium font-mono">{user?.bar_council_number}</p>
              </div>
              <div>
          ...
          <div>
            ...
            <p className="font-medium">{userRole === 'lawyer' ? 'Lawyer' : 'Client'}</p>
          </div>
        </CardContent>
      </Card>
    </div>

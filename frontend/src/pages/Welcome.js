        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          >
            <CardContent className="pt-12 pb-12 text-center">
              ...
              <h2 className="text-2xl font-bold font-serif text-foreground mb-3">Join as Lawyer</h2>
          ...
          >
            <CardContent className="pt-12 pb-12 text-center">
              ...
              <h2 className="text-2xl font-bold font-serif text-foreground mb-3">Join as Client</h2>
              <p className="text-muted-foreground mb-6">
